    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          required
          minLength={10}
          className="w-full border border-sand px-4 py-2.5 text-sm transition-colors duration-200 focus:border-[#25D366] focus-visible:outline-none"
        />
      </div>
      <button
        type="submit"
        className="inline-flex w-full items-center justify-center gap-2 rounded-sm bg-[#25D366] px-6 py-3.5 text-sm font-medium tracking-wide uppercase text-white transition-all duration-300 ease-[var(--ease-organic)] hover:-translate-y-0.5 hover:bg-[#128C7E] hover:shadow-lg hover:shadow-[#25D366]/20 active:translate-y-0 sm:w-auto sm:px-8"
      >
